...
var app = angular.module("geo", ['ngRoute',"ui.map", "ui.event","readMore"])
      ...
      if(i==0)
      {
        ...
        var createMarker = function (info)
        {
          ...
          if(info !="" || typeof info !="undefined")
          {
            ...
            marker.content = '<div><a href="#outlet/">' + titles + '</a> <i class="fa fa-info"></i></div>';
            ...
            google.maps.event.addListener(marker, 'click', function() {
              ...
              $scope.$apply();
              $scope.infoWindow.setContent('<a href="'+url+'"><h4>'+this.title+'  <i class="fa fa-info"></i></h4></a>');
...
.success(function (response) {
 ...
 for (i = 0; i < results.length; i++) {
  ...
  var image=datas[0].title;
  $scope.image = image.replace(/ /g, '-');
